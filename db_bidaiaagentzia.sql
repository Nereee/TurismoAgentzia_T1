...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-01-2025 a las 13:21:16
...
('ag1', 'Agentzia_T1', NULL, NULL, 'admin', 'admin', NULL, NULL);
...
CREATE TABLE `jarduerak` (
  ...
  `PREZIOA` decimal(10,0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
ALTER TABLE `ekitaldiak`
  ADD CONSTRAINT `ekitaldiak_ibfk_1` FOREIGN KEY (`ID_BIDAIA`) REFERENCES `bidaiak` (`ID_BIDAIA`) ON DELETE CASCADE ON UPDATE CASCADE;
